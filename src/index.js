...
function callApi(event) {
  ...
  let context =
    "Please generate inspirational and motivational quotes which are short sentences. Each quote is placed within double quotation marks. write each quote like this format: quote<br/>. Give a number to each quote. Also only write quotes without any explanations";
